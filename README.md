[![PWC](https://img.shields.io/endpoint.svg?url=https://paperswithcode.com/badge/i2l-meshnet-image-to-lixel-prediction-network/3d-human-pose-estimation-on-3dpw)](https://paperswithcode.com/sota/3d-human-pose-estimation-on-3dpw?p=i2l-meshnet-image-to-lixel-prediction-network)
[![PWC](https://img.shields.io/endpoint.svg?url=https://paperswithcode.com/badge/i2l-meshnet-image-to-lixel-prediction-network/3d-hand-pose-estimation-on-freihand)](https://paperswithcode.com/sota/3d-hand-pose-estimation-on-freihand?p=i2l-meshnet-image-to-lixel-prediction-network)
...
## News
:tada: Our I2L-MeshNet wons the **first and second place** at [3DPW challenge](https://virtualhumans.mpi-inf.mpg.de/3DPW_Challenge/) on unknown assocation track in part orientation and joint position metrics, respectively. :tada:
...
* Download `basicModel_f_lbs_10_207_0_v1.0.0.pkl`, `basicModel_m_lbs_10_207_0_v1.0.0.pkl`,  at `common/utils/smplpytorch/smplpytorch/native/models` from [here](https://smpl.is.tue.mpg.de). and `basicModel_neutral_lbs_10_207_0_v1.0.0.pkl` from 
[here](https://github.com/classner/up/blob/master/models/3D/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl)
